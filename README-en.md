<p align="center">
  ...
  <em>Write Novels with Claude Code / OpenCode / Reasonix / Codex / ZCode / OpenClaw</em>
</p>
...
- A computer with [Claude Code](https://docs.anthropic.com/en/docs/claude-code/overview), [OpenCode](https://github.com/sglaboratory/opencode), Reasonix, **Codex**, **ZCode** or **OpenClaw** installed
- Python 3.9+ (the one bundled with macOS works; 3.11+ recommended)
- pyyaml for OpenCode / Codex / ZCode / OpenClaw (`pip install pyyaml`; use `pip install --user pyyaml` if the system Python is permission-restricted)
